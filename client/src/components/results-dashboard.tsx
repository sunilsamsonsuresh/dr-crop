...
export default function ResultsDashboard({ result, onNewScan }: ResultsDashboardProps) {
  ...
  const downloadReport = (analysisResult: AnalysisResult) => {
    const reportContent = `
...
Severity: ${analysisResult.severity} (${analysisResult.severity_percent}%)

ORGANIC TREATMENT RECOMMENDATIONS
----------------------------------
${analysisResult.organic_diagnosis}

CHEMICAL TREATMENT RECOMMENDATIONS
-----------------------------------
${analysisResult.chemical_diagnosis}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="p-4">
            <div className="space-y-3">
              {result.organic_diagnosis.split('\n• ').filter(item => item.trim()).map((item, index) => (
        ...
        <Card>
          ...
          <CardContent className="p-4">
            <div className="space-y-3">
              {result.chemical_diagnosis.split('\n• ').filter(item => item.trim()).map((item, index) => (
                <div key={index} className="flex items-start space-x-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        ...
        <Card className="p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="font-semibold text-foreground">Treatment Summary</h3>
          </div>
          <div className="text-sm text-muted-foreground">
            <p>Based on the analysis, we've identified the best treatment approach for your plant. Follow the organic and chemical treatment recommendations above for optimal results.</p>
          </div>
        </Card>
            ...
            {analyses.map((analysis: Analysis) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-foreground truncate" data-testid={`analysis-disease-${analysis.id}`}>
                    {analysis.disease}
                  </p>
